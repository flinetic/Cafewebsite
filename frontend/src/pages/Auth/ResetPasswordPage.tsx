                ...
                <div className="bg-white rounded-3xl shadow-2xl p-10">
                    {resetSuccess ? (
                        ...
                        <div className="text-center">
                            ...
                            <Link
                                to="/login"
                                className="flex items-center justify-center gap-2 w-full py-4 bg-gradient-to-r from-caramel to-mocha text-white rounded-xl hover:from-caramel hover:to-primary-400 transition-all font-semibold text-lg shadow-lg"
                            >
                                Go to Login
                            </Link>
                        </div>
